package com.sapient.gateway.config.security.jwt;

import com.sapient.gateway.config.Constants;
import com.sapient.gateway.dto.AuthenticationResponse;
import com.sapient.gateway.repository.AuthenticationRepository;
...
public class JwtProvider implements InitializingBean {
    ...
    @Value("${sapient.jwt.secret}")
    private String secretKey;

    @Value("${sapient.jwt.validityInSeconds}")
